...
extension YeniGunlukForm: CloudKitConvertible {
    ...
    func toCKRecord() -> CKRecord {
        ...
        // Note: Nested data (gunlukVeriler) NOT synced to keep it simple
        // Each device maintains its own detailed data
...
// MARK: - SarnelForm CloudKit Extension (Simplified)
...
extension SarnelForm: CloudKitConvertible {
    ...
    func toCKRecord() -> CKRecord {
        ...
        // Note: Detailed form data NOT synced
...
// MARK: - KilitToplamaForm CloudKit Extension (Simplified)
